                ...
                <div className="nChat">
                    <div className="chat_top">
                        <div className="supportInfo">
                            <div className="spImg">
                                <img src={'https://scontent.fhan2-4.fna.fbcdn.net/v/t1.0-1/p160x160/35299905_2240657562620977_956875553422442496_n.jpg?_nc_cat=104&oh=5e02df68fdf52db8e4ef49ae3b4e895b&oe=5C24AE57'}/>
                            </div>
                            ...
                            <a className="logoNhanh">
                                <img src={'https://nhanh.vn/images/logo/nhanh_black2.png'}/>
                            </a>
                        </div>
                    </div>
